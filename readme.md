...
- `-iexclude_samples` (`str`): comma separated string of samples to exclude from CNV calling / reports
- `-iexclude_samples_file` (`file`): file of samples to exclude from CNV calling / reports, one sample name per line (as found in manifest)
